...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <div style="position:absolute; left:293px; top:149px; width: 823px; height: 341px; margin-top: 3px;">
    ...
    <asp:Panel ID="email_panel" runat="server" Height="77px" Visible="False" 
        ...
        <table style="width: 99%;">
            <tr>
                <td class="style14"
                style="font-family: 'Segoe UI'; font-weight: lighter; color: #333333;">
                    <asp:Label ID="Label2" runat="server" Text="Enter your EmailAddress"></asp:Label>
                </td>
                <td class="style15">
                    &nbsp;&nbsp;&nbsp;&nbsp;
